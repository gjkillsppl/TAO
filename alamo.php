...
<div class="animsition-overlay">
  ...
  –––––––––––––––––––––––––––––––––––––––––––––––––– -->
        ...
        <section class="container about  pad-top pad-bottom">
          ...
          <div class="row">
                <article class="col-md-5 text-left  inner-pad">
                  <h6 class="super-text-2 san  font2bold black">Alamo</h6>
                </article>
    ...
    <section class="parallax-showcase-wrap ">
      ...
      <div class="parallax-window" data-parallax="scroll" data-image-src="images/works/alamo/01.jpg" data-position-x="center" ></div>
      <div class="parallax-window" data-parallax="scroll" data-image-src="images/works/alamo/02.jpg" data-position-x="center"></div>
      <div class="container-fluid">

        <div class="row">
          <div class="col-md-12">
            <div class="parallax-window col-md-6" data-parallax="scroll" data-image-src="images/works/alamo/21.jpg" data-android-fix="true"></div>
            <div class="parallax-window col-md-6" data-parallax="scroll" data-image-src="images/works/alamo/20.jpg" data-android-fix="true" ></div>
          </div>
      ...
      <div class="parallax-window" data-parallax="scroll" data-image-src="images/works/alamo/8.jpg" data-position-x="center" data-natural-width="633" data-android-fix="true"></div>
      <div class="parallax-window" data-parallax="scroll" data-image-src="images/works/alamo/7.jpg" data-position-x="center" data-natural-width="633" data-android-fix="true"></div>
